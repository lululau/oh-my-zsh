...
plugins=(git autojump battery colorize colored-man command-not-found compleat cp cpanm encode64 gem gemcd github gnu-utils go golang history jruby macports mvn mysql-macports node npm osx perl pip python rails rake rsync ruby rvm safe-paste scala screen sublime svn terminalapp terminitor textmate themes bundler httpie ack2)
